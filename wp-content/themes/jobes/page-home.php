...
<div id="copy"> 
	...
	<div class="blocks">
		<div class="block one">
			<?php $attachment_id = get_post_meta( $post->ID, 'block_one_image','block', true ); 
			$image_attributes_one = wp_get_attachment_image_src( $attachment_id ); ?>
			<div class="round">
		...
		<div class="block two">
			<?php $attachment_id = get_post_meta( $post->ID, 'block_two_image', 'block', true ); 
			$image_attributes_two = wp_get_attachment_image_src( $attachment_id ); ?>
			<div class="round">
		...
		<div class="block three">
			<?php $attachment_id = get_post_meta( $post->ID, 'block_three_image', 'block', true ); 
			$image_attributes_three = wp_get_attachment_image_src( $attachment_id ); ?>
			<div class="round">
